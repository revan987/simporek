        ...
        <div class="section-body">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Semua Obat Masuk</h4>
                            <div class="section-header-button">
                                <div class="btn-group mr-12">
                                </div>
                                <a href="{{ route('obatmasuks.create') }}" class="btn btn-primary">Tambahkan</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="float-right">
                                <form method="GET" action="{{ route('obatmasuks.index') }}">
                            ...
                            <div class="table-responsive">
                                <table class="table-striped table">
                                    <tr>
                                        ...
                                        <th style="width: 10%; text-align:center">Jumlah Obat Masuk</th>
                                        <th style="width: 15%; text-align:center">Tanggal Masuk</th>
                                        <th style="width: 15%; text-align:center">Action</th>
                                    </tr>
                                    @foreach ($obatmasuks as $obatmasuk)
                                        <tr>
                                            <td style="text-align:center">{{ $obatmasuk->id_obat }}</td>
                                            <td style="text-align:center">{{ $obatmasuk->nama_obat }}</td>
                                            <td style="text-align:center">{{ $obatmasuk->jumlah_masuk }}</td>
                                            <td style="text-align:center">{{ \Carbon\Carbon::parse($obatmasuk->tanggal_masuk)->format('d/m/Y') }}</td>
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href='{{ route('obatmasuks.edit', $obatmasuk->id) }}'
                                                        class="btn btn-sm btn-info btn-icon">
                                                        <i class="fas fa-edit"></i>
                                                        Edit
                                                    </a>

                                                    <form action="{{ route('obatmasuks.destroy', $obatmasuk->id) }}" method="POST"
                                                        class="ml-2">
                                                        @csrf
                                                        @method('DELETE')
